...
def load_raw_data(file_path,vectorizer,dataset_index):
    if dataset_index==2:
        ...
        T=df[["rptallpr","rptpr","rptcmt","rptallcmt","rptpronum","rptstar",
        "rptfoll","rptalliss",'rpthascomment', 'rptisnew', 'rpthasevent',"rptnpratio","rptissnum","labels"]]


    elif dataset_index==1:
        df = pd.read_pickle(file_path)
        
        T=df[["rptallpr","rptpr","rptcmt","rptallcmt","rptpronum","rptstar","rptfoll","rptalliss",'rptisnew', 
